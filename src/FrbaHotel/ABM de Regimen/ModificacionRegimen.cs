...
namespace FrbaHotel.Regimen
{
    public partial class Modificacion : Form
    {
        ...
        public Modificacion(string accion , string queryParam)
        {
            ...
            query = queryParam;
            textBox1.Text = FrbaHotel.Home.BD.executeAndReturn("SELECT IDENT_CURRENT ('EN_CASA_ANDABA.Regimenes')+1");
        }
        ...
        private void buttonAceptar_Click(object sender, EventArgs e)
        {
            switch (buttonAceptar.Text)
            {
                ...
                case "Borrar":
                    ...
                    break;
                case "Modificar":
                    query = query + "reg_desc = '" + textBox2.Text + "', reg_precio = " + textBox3.Text.Replace(',','.') + ", reg_habilitado = '" + checkBox1.Checked + "' WHERE reg_id=" + textBox1.Text;
                    FrbaHotel.Home.BD.executeOnly(query);
                    break;
                default:
                    break;
