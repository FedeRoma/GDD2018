...
{
    public partial class AltaUser : Form
    {
        ...
        public AltaUser()
        {
            ...
            consulta = "select hot_calle + hot_calle_nro from EN_CASA_ANDABA.Hoteles where idHotel = " +Login.HomeLogin.hotel;
        ...
        private void AltaUser_Load(object sender, EventArgs e)
        {
            cliente = "";
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            bool estado = false;
            resultado = Home.BD.comando("select cli_habilitado from EN_CASA_ANDABA.Clientes where cli_doc_id =" + textBox2.Text);
            if (resultado.Read())
            {
            ...
            string insert = "EXEC EN_CASA_ANDABA.altaReserva";
            ...
            string comand = "EXEC EN_CASA_ANDABA.altaReservaHabitacion " + id.ToString() + ",";

            string[] strArr = null;
            int count = 0;
            char[] splitchar = { ',' };
            comand = "EN_CASA_ANDABA.altaReservaHabitacion " + id.ToString() + ",";
        ...
        {
            ABM_de_Cliente.Alta altaCliente = new ABM_de_Cliente.Alta("altaReservaUser");
            altaCliente.Show();
        }

        private void button5_Click(object sender, EventArgs e)
        {
            clientesExistentes cli = new clientesExistentes("altaReservaUser");
            cli.Show();
        }

        private void AltaUser_Activated(object sender, EventArgs e)
        {
            if (cliente != "")
            {
