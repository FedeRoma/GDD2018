...
namespace FrbaHotel.Generar_Modificar_Reserva
{
    public partial class AltaCli : Form
    {
        ...
        {
            InitializeComponent();
            consulta = "select distinct hot_calle + hot_calle_nro from EN_CASA_ANDABA.Hoteles";
        ...
        {
            consulta = "EXEC EN_CASA_ANDABA.buscarTiposHabitacionesHotel '" + comboBox1.SelectedItem + "'";
            //
            resultado = Home.BD.comando(consulta);
            ...
            resultado.Close();
            consulta = "EXEC EN_CASA_ANDABA.buscarRegimenesHotel'" + comboBox1.SelectedItem + "'";
            resultado = Home.BD.comando(consulta);
