...
namespace FrbaHotel.Generar_Modificar_Reserva
{
    public partial class Modificacion : Form
    {
        ...
        public Modificacion(string idReserva)
        {
            ...
            consulta = "Select hot.hot_calle, res.res_inicio, res.res_fin, reg.reg_desc,res.res_cli_documento, est.est_precio From EN_CASA_ANDABA.Reservas res,EN_CASA_ANDABA.Hoteles hot, EN_CASA_ANDABA.Regimenes reg, EN_CASA_ANDABA.Habitaciones hab, EN_CASA_ANDABA.Reservas_Habitaciones res_hab Where reg.reg_id = res.res_reg_id and res_hab.ryh_res_id = res.res_id and res_hab.ryh_hab_id=hab.hab_id and hab.hab_hot_id = hot.hot_id and res.res_id = " + idReserva;
            ...
            consulta = "EXEC EN_CASA_ANDABA.buscarTiposHabitacionesHotel '" + textBox3.Text + "'";
            resultado = Home.BD.comando(consulta);
            ...
            resultado.Close();
            consulta = "EXEC EN_CASA_ANDABA.buscarRegimenesHotel '" + textBox3.Text + "'";
            resultado = Home.BD.comando(consulta);
            while (resultado.Read() == true)
            {
            ...
            consulta = "EXEC EN_CASA_ANDABA.buscarReservaHabitacion " + idReserva;
            resultado = Home.BD.comando(consulta);
            while (resultado.Read() == true)
            {
        ...
        {
            consulta = "select tip_personas from EN_CASA_ANDABA.TiposHabitaciones = '" + comboBox2.SelectedItem + "'";
            resultado = Home.BD.comando(consulta);
            if (resultado.Read())
            {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string query = "EXEC EN_CASA_ANDABA.buscarHabitacionesDisponibles ";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            bool estado = false;
            resultado = Home.BD.comando("select cli_habilitado from EN_CASA_ANDABA.Clientes where cli_id =" + textBox2.Text);
            if (resultado.Read())
            {
            ...
            if (cambio == 1)
            {
                comand = "EXEC EN_CASA_ANDABA.bajaReservaHabitacion " + id.ToString() + ",";
            ...
            comand = "EXEC EN_CASA_ANDABA.altaReservaHabitacion " + id.ToString() + ",";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            string con = "select Cli.cli_nombre,Cli.cli_apellido,doc.doc_desc,Cli.cli_documento,Cli.cli_mail,Cli.cli_telefono,Cli.cli_nacionalidad,Cli.cli_calle + Cli.cli_calle_nro,Cli.cli_fecha_nac,Cli.cli_habilitado from EN_CASA_ANDABA.Clientes Cli,EN_CASA_ANDABA.Documentos doc where Cli_cli_doc_id = Doc.doc_id and Cli.cli_id = " + textBox2.Text;
