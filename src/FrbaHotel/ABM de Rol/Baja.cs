...
namespace FrbaHotel.ABM_de_Rol
{
    public partial class Baja : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                string query = "select Fun.fun_id ID,Fun.fun_desc Denominacion from EN_CASA_ANDABA.Funcionalidades Fun, EN_CASA_ANDABA.Funcionalidades_Roles FR where Fun.fun_id= FR.fyr_rol_id and FR.fyr_rol_id = " + dataGridView1.CurrentRow.Cells[2].Value.ToString(); ;
            ...
            if (e.ColumnIndex == 1)
            {
                ...
                {
                    string consulta = "update EN_CASA_ANDABA.Roles set rol_estado=0 where rol_id = " + id;
