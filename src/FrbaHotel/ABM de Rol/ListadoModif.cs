...
namespace FrbaHotel.ABM_de_Rol
{
    public partial class ListadoModif : Form
    {
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                string query = "select Fun.fun_id ID,Fun.fun_desc Denominacion from EN_CASA_ANDABA.Funcionalidades Fun, EN_CASA_ANDABA.Funcionalidades_Roles FR where Fun.fun_id = FR.fyr_fun_id and FR.fyr_rol_id = " + dataGridView1.CurrentRow.Cells[2].Value.ToString(); ;
            ...
            if (e.ColumnIndex == 1)
            {
                ...
                Modificacion modif = new Modificacion(id, nombre, estado);
                modif.Show();
            }
